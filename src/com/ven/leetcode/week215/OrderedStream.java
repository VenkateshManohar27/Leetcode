package com.ven.leetcode.week215;
 ...
 * 
 * Explanation // Note that the values ordered by ID is ["aaaaa", "bbbbb",
 * "ccccc", "ddddd", "eeeee"]. OrderedStream os = new OrderedStream(5);
 * os.insert(3, "ccccc"); // Inserts (3, "ccccc"), returns []. os.insert(1,
 * "aaaaa"); // Inserts (1, "aaaaa"), returns ["aaaaa"]. os.insert(2, "bbbbb");
 * // Inserts (2, "bbbbb"), returns ["bbbbb", "ccccc"]. os.insert(5, "eeeee");
 * // Inserts (5, "eeeee"), returns []. os.insert(4, "ddddd"); // Inserts (4,
 * "ddddd"), returns ["ddddd", "eeeee"]. // Concatentating all the chunks
 * returned: // [] + ["aaaaa"] + ["bbbbb", "ccccc"] + [] + ["ddddd", "eeeee"] =
 * ["aaaaa", "bbbbb", "ccccc", "ddddd", "eeeee"] // The resulting order is the
 * same as the order above.
 * 
 * 
 * Constraints:
 * 
 * 1 <= n <= 1000 1 <= id <= n value.length == 5 value consists only of
 * lowercase letters. Each call to insert will have a unique id. Exactly n calls
 * will be made to insert.
 * 
