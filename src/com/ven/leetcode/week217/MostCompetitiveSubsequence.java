package com.ven.leetcode.week217;
 ...
 * Example 1:
 * 
 * Input: nums = [3,5,2,6], k = 2 Output: [2,6] Explanation: Among the set of
 * every possible subsequence: {[3,5], [3,2], [3,6], [5,2], [5,6], [2,6]}, [2,6]
 * is the most competitive. Example 2:
 * 
...
public class MostCompetitiveSubsequence {
	...
	public static void main(String[] args) {
		MostCompetitiveSubsequence m = new MostCompetitiveSubsequence();
		m.mostCompetitive(new int[] { 3, 5, 2, 6 }, 2);
		m.mostCompetitive(new int[] { 2, 4, 3, 3, 5, 4, 9, 6 }, 4);
	}
}
