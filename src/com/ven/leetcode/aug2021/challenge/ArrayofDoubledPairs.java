 ...
 * Example 1:
 * 
 * Input: arr = [3,1,3,6] Output: false Example 2:
 * 
 * Input: arr = [2,1,2,6] Output: false Example 3:
 * 
 * Input: arr = [4,-2,2,-4] Output: true Explanation: We can take two groups,
 * [-2,-4] and [2,4] to form [-2,-4,2,4] or [2,4,-2,-4]. Example 4:
 * 
