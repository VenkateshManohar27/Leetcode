 ...
 * [10,9] has the maximum total sum of its elements. Example 2:
 * 
 * Input: nums = [4,4,7,6,7] Output: [7,7,6] Explanation: The subsequence [7,7]
 * has the sum of its elements equal to 14 which is not strictly greater than
 * the sum of elements not included (14 = 4 + 4 + 6). Therefore, the subsequence
 * [7,6,7] is the minimal satisfying the conditions. Note the subsequence has to
