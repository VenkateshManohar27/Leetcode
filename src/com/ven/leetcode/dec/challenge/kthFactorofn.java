 ...
 * is only 3 factors. We should return -1. Example 4:
 * 
 * Input: n = 1, k = 1 Output: 1 Explanation: Factors list is [1], the 1st
 * factor is 1. Example 5:
 * 
 * Input: n = 1000, k = 3 Output: 4 Explanation: Factors list is [1, 2, 4, 5, 8,
