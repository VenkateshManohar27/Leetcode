 ...
 * following operations: - Delete a 3 to earn 3 points. All 2's and 4's are also
 * deleted. nums = [3,3]. - Delete a 3 again to earn 3 points. nums = [3]. -
 * Delete a 3 once more to earn 3 points. nums = []. You earn a total of 9
 * points.
 * 
 * 
 * Constraints:
...
public class DeleteAndEarn {
	public int deleteAndEarn(int[] nums) {
        ...
        for(int i = 2; i <=largest; i++){
            ...
            max = Math.max( i * freq[i] + dp[i-2], dp[i-1]);
            dp[i] = max;
        }
        return max;
    }
