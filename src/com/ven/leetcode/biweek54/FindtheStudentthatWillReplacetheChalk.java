 ...
 * not have enough chalk, so they will have to replace it. Example 2:
 * 
 ...
 * Constraints:
 * 
 * chalk.length == n 1 <= n <= 105 1 <= chalk[i] <= 105 1 <= k <= 109
 * 
...
public class FindtheStudentthatWillReplacetheChalk {
	...
	public static void main(String[] args) {
		...
		FindtheStudentthatWillReplacetheChalk b = new FindtheStudentthatWillReplacetheChalk();
		System.out.print(b.chalkReplacer(new int[] { 5, 1, 5 }, 22));
		System.out.print(b.chalkReplacer(new int[] { 3, 4, 1, 2 }, 25));
	}
