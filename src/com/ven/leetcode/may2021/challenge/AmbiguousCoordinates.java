 ...
 * Example 2:
 * 
 * Input: s = "(0123)" Output: ["(0, 1.23)","(0, 12.3)","(0, 123)","(0.1,
 * 2.3)","(0.1, 23)","(0.12, 3)"] Explanation: 0.0, 00, 0001 or 00.01 are not
 * allowed. Example 3:
 * 
 * Input: s = "(00011)" Output: ["(0, 0.011)","(0.001, 1)"] Example 4:
 * 
 ...
 * Constraints:
 * 
 * 4 <= s.length <= 12 s[0] == '(' and s[s.length - 1] == ')'. The rest of s are
 * digits.
 * 
