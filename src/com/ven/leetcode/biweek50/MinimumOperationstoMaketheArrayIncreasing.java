 ...
 * nums = [1,3,3]. Return the minimum number of operations needed to make nums
 * strictly increasing.
 * 
 ...
 * Example 1:
 * 
 * Input: nums = [1,1,1] Output: 3 Explanation: You can do the following
 * operations: 1) Increment nums[2], so nums becomes [1,1,2]. 2) Increment
 * nums[1], so nums becomes [1,2,2]. 3) Increment nums[2], so nums becomes
 * [1,2,3]. Example 2:
 * 
