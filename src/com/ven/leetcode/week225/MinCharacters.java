...
public class MinCharacters {
	...
	public static void main(String[] args) {
		...
		System.out.println(m.minCharacters("ae", "b"));
		System.out.println(m.minCharacters("da", "cced"));

		System.out.println(m.minCharacters("aba", "caa"));
		System.out.println(m.minCharacters("dabadd", "cda"));
		System.out.println(m.minCharacters("dee", "a"));
	}
}
