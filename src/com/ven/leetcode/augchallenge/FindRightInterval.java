 ...
 * [2,3], the interval [3,4] has minimum-"right" start point. NOTE: input types
 * have been changed on April 15, 2019. Please reset to default code definition
...
public class FindRightInterval {
	...
	public static void main(String[] args) {
		...
		ArrayUtility.print(f.findRightInterval(new int[][] { { 1, 2 } }));
		ArrayUtility.print(f.findRightInterval(new int[][] { { 3, 4 }, { 2, 3 }, { 1, 2 } }));
		ArrayUtility.print(f.findRightInterval(new int[][] { { 1,4}, {2,3}, {3,4} }));
	}
}
