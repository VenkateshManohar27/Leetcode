 ...
 * j+1). When any robot is passing through a cell, It picks it up all cherries,
 * and the cell becomes an empty cell (0). When both robots stay on the same
 * cell, only one of them takes the cherries. Both robots cannot move outside of
 * the grid at any moment. Both robots should reach the bottom row in the grid.
 * 
 * 
 * Example 1:
 * 
 * 
 * 
 * Input: grid = [[3,1,1],[2,5,1],[1,5,5],[2,1,1]] Output: 24 Explanation: Path
 * of robot #1 and #2 are described in color green and blue respectively.
 ...
 * Output: 28 Explanation: Path of robot #1 and #2 are described in color green
 * and blue respectively. Cherries taken by Robot #1, (1 + 9 + 5 + 2) = 17.
 * Cherries taken by Robot #2, (1 + 3 + 4 + 3) = 11. Total of cherries: 17 + 11
 * = 28. Example 3:
 * 
...
public class CherryPickupII {
	...
	public static void main(String[] args) {
		...
		System.out.println(c.cherryPickup(new int[][] { { 3, 1, 1 }, { 2, 5, 1 }, { 1, 5, 5 }, { 2, 1, 1 } }));
	}
}
