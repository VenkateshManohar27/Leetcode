...
public class SumofAllSubsetXORTotals {
    ...
    private int helper(int[] nums, int i, int v) {
        if(i == nums.length) return 0;
        return (v ^ nums[i]) + helper(nums, i+1, v) + helper(nums, i+1, v ^ nums[i]);
    }

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		SumofAllSubsetXORTotals a = new SumofAllSubsetXORTotals();
