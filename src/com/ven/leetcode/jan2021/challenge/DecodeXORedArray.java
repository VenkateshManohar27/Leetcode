 ...
 * Example 1:
 * 
 * Input: encoded = [1,2,3], first = 1 Output: [1,0,2,1] Explanation: If arr =
 * [1,0,2,1], then first = 1 and encoded = [1 XOR 0, 0 XOR 2, 2 XOR 1] = [1,2,3]
 * Example 2:
 * 
 ...
 * Constraints:
 * 
 * 2 <= n <= 104 encoded.length == n - 1 0 <= encoded[i] <= 105 0 <= first <=
 * 105
 * 
