 ...
 * and the XOR sum of [3] is equal to 3. You are given two 0-indexed arrays arr1
 * and arr2 that consist only of non-negative integers.
 * 
 ...
 * = 0 XOR 1 XOR 2 XOR 0 XOR 2 XOR 1 = 0. Example 2:
 * 
 * Input: arr1 = [12], arr2 = [4] Output: 4 Explanation: The list = [12 AND 4] =
 * [4]. The XOR sum = 4.
 * 
 * 
 * Constraints:
 * 
 * 1 <= arr1.length, arr2.length <= 105 0 <= arr1[i], arr2[j] <= 109
 * 
