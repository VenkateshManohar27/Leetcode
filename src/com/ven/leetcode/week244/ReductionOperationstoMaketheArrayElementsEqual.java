...
public class ReductionOperationstoMaketheArrayElementsEqual {
	...
	public static void main(String[] args) {
		ReductionOperationstoMaketheArrayElementsEqual b = new ReductionOperationstoMaketheArrayElementsEqual();
		System.out.println(b.reductionOperations(new int[] { 5, 1, 3 }));
		System.out.println(b.reductionOperations(new int[] { 1, 1, 1 }));
		System.out.println(b.reductionOperations(new int[] { 1, 1, 2 }));
		System.out.println(b.reductionOperations(new int[] { 1, 1, 2, 2, 3 }));
	}
