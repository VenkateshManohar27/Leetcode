 ...
 * dist[i] is the initial distance in meters of the ith monster from the city.
 * 
 ...
 * is the speed of the ith monster in meters per minute.
 * 
 ...
 * minute 0, the distances of the monsters are [1,3,4], you eliminate the first
 * monster. At the start of minute 1, the distances of the monsters are [X,2,3],
 * you don't do anything. At the start of minute 2, the distances of the
 * monsters are [X,1,2], you eliminate the second monster. At the start of
 * minute 3, the distances of the monsters are [X,X,1], you eliminate the third
 * monster. All 3 monsters can be eliminated. Example 2:
 * 
 * Input: dist = [1,1,2,3], speed = [1,1,1,1] Output: 1 Explanation: At the
 * start of minute 0, the distances of the monsters are [1,1,2,3], you eliminate
 * the first monster. At the start of minute 1, the distances of the monsters
 * are [X,0,1,2], so you lose. You can only eliminate 1 monster. Example 3:
 * 
 * Input: dist = [3,2,4], speed = [5,3,2] Output: 1 Explanation: At the start of
 * minute 0, the distances of the monsters are [3,2,4], you eliminate the first
 * monster. At the start of minute 1, the distances of the monsters are [X,0,2],
