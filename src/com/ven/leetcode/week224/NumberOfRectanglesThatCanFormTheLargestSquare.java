 ...
 * Example 1:
 * 
 * Input: rectangles = [[5,8],[3,9],[5,12],[16,5]] Output: 3 Explanation: The
 * largest squares you can get from each rectangle are of lengths [5,3,5,5]. The
 * largest possible square is of length 5, and you can get it out of 3
 * rectangles. Example 2:
 * 
 ...
 * Constraints:
 * 
 * 1 <= rectangles.length <= 1000 rectangles[i].length == 2 1 <= li, wi <= 109
 * li != wi
 * 
