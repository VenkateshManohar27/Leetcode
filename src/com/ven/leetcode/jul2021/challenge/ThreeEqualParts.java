 ...
 * 
 * arr[0], arr[1], ..., arr[i] is the first part, arr[i + 1], arr[i + 2], ...,
 * arr[j - 1] is the second part, and arr[j], arr[j + 1], ..., arr[arr.length -
 * 1] is the third part. All three parts have equal binary values. If it is not
 * possible, return [-1, -1].
 * 
