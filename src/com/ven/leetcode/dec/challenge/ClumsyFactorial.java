 ...
 * Note:
 * 
 * 1 <= N <= 10000 -2^31 <= answer <= 2^31 - 1 (The answer is guaranteed to fit
...
public class ClumsyFactorial {
	public int clumsy(int N) {
        ...
        for(int i = N-1; i > 0; i--){
            op = op %4;
            switch(op){
                case 0: clumsy = clumsy * i;
                break;
                case 1: clumsy = (int)Math.floor(clumsy / i);
                break;
                case 2: clumsy = clumsy + i;
                break;
                case 3: clumsy = clumsy - i;
                break;
            }
	...
	public static void main(String[] args) {
		...
		System.out.println(c.clumsy(4));
		System.out.println(c.clumsy(10));
	}
}
