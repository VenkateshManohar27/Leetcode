 ...
 *
 */
public class MaximumProductTwoElementsinanArray {
	...
	public static void main(String[] args) {
		MaximumProductTwoElementsinanArray m = new MaximumProductTwoElementsinanArray();
		System.out.println(m.maxProduct(new int[] { 3, 4, 5, 2 }));
		System.out.println(m.maxProduct(new int[] { 1, 5, 4, 5 }));
		System.out.println(m.maxProduct(new int[] { 3, 7 }));
	}
}
