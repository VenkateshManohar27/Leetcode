...
public class ArrayUtility {
	 ...
	 */
	public static boolean greater(final Comparable obj1, final Comparable obj2) {
		return obj1.compareTo(obj2) > 0;
	}
	 ...
	 *            index j.
	 */
	public static void exch(final Comparable[] array, final int i, final int j) {
	 ...
	 *            index j.
	 */
	public static void exchForHeap(final Comparable[] array, final int i, final int j) {
		Comparable swap = array[i];
		array[i] = array[j - 1];
		array[j - 1] = swap;
	}
