 ...
 * exactly the 6 hour mark. Example 2:
 * 
 ...
 * Constraints:
 * 
 * n == dist.length 1 <= n <= 105 1 <= dist[i] <= 105 1 <= hour <= 109 There
 * will be at most two digits after the decimal point in hour.
 * 
